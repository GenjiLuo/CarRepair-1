...
public class MainMassageActivity extends Activity {
	...
	private final String TAG = "MainMassageActivity";
	private final String GRID_FROM_IMAGE = "image";
	private final String GRID_FROM_TITILE = "title";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGridView = (GridView) findViewById(R.id.car_gridview);
		String[] from = {GRID_FROM_IMAGE,GRID_FROM_TITILE};
		...
		mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				Log.v(TAG, "Grid position:" + position + "clicked!!");
			}
		});
	...
	public void setSpinner(){
		...
		mSpinner = (Spinner) findViewById(R.id.car_spinner);
//		mSpinner.setSelection(1, true);
	...
	public ArrayList<HashMap<String, Object>> setGridViewData(){
		...
		item.put(GRID_FROM_IMAGE, R.drawable.ic_category_0);
		item.put(GRID_FROM_TITILE, "美食");
		data.add(item);
		item = new HashMap<String, Object>();
		item.put(GRID_FROM_IMAGE, R.drawable.ic_category_1);
		item.put(GRID_FROM_TITILE, "电影");
		data.add(item);
		item = new HashMap<String, Object>();
		item.put(GRID_FROM_IMAGE, R.drawable.ic_category_2);
		item.put(GRID_FROM_TITILE, "酒店");
		data.add(item);
		item = new HashMap<String, Object>();
		item.put(GRID_FROM_IMAGE, R.drawable.ic_category_3);
		item.put(GRID_FROM_TITILE, "KTV");
		data.add(item);
		item.put(GRID_FROM_IMAGE, R.drawable.ic_category_5);
		item.put(GRID_FROM_TITILE, "代金券");
		data.add(item);
		item = new HashMap<String, Object>();
		item.put(GRID_FROM_IMAGE, R.drawable.ic_category_6);
		item.put(GRID_FROM_TITILE, "景点门票");
		data.add(item);
		item = new HashMap<String, Object>();
		item.put(GRID_FROM_IMAGE, R.drawable.ic_user_main_favorite);
		item.put(GRID_FROM_TITILE, "今日更新");
		data.add(item);
		item = new HashMap<String, Object>();
		item.put(GRID_FROM_IMAGE, R.drawable.ic_category_15);
		item.put(GRID_FROM_TITILE, "更多");
		data.add(item);
	...
	public void setdata(ArrayList<View> data){
		...
		View v = LayoutInflater.from(this).inflate(R.layout.car_viewpager_one, null);
		data.add(v);
		v = LayoutInflater.from(this).inflate(R.layout.car_viewpager_two, null);
		data.add(v);
		v = LayoutInflater.from(this).inflate(R.layout.car_viewpager_three, null);
		data.add(v);
	}
